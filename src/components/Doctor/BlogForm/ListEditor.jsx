        ...
        <div className="space-y-3">
            <div className="flex items-center justify-between">
                <label className="label">
                    <span className="label-text font-semibold text-[#403D27]">List Items</span>
                </label>
                <button
                    type="button"
                    onClick={() => append('')}
                ...
                <Controller
                    ...
                    render={({ field: inputField }) => (
                        <div className="flex gap-2 items-center">
                            <span className="text-lg text-[#B7B687]">•</span>
                            <input
                                {...inputField}
                                type="text"
            ...
            {fields.length === 0 && (
                <p className="text-sm text-[#6d7571] italic">No list items yet.</p>
            )}
        </div>
    );
};
